...
/***********************************************************************
        ...
        Exynos 850: 8x Cortex-A55, single homogeneous cluster
************************************************************************/
SMBIOS_TABLE_TYPE4 mProcessorInfoType4_a55 = {
    ...
    0,                     // ExternalClock;
    2000,                  // MaxSpeed;        (Cortex-A55 @ ~2.0GHz)
    2000,                  // CurrentSpeed;
    0x41,                  // Status;
...
CHAR8 mCpuName[128] = "Samsung Exynos 850";

CHAR8 *mProcessorInfoType4Strings[] = {
    "BGA", "Samsung", "Exynos 850", NULL};

/***********************************************************************
        SMBIOS data definition  TYPE7  Cache Information
        Cortex-A55: 32KB L1I + 32KB L1D per core, 512KB shared L2
************************************************************************/
...
SMBIOS_TABLE_TYPE7 mCacheInfoType7_a55_L2 = {
    ...
    0x0181, // Cache Configuration
            ...
            // Operational Mode   :2  (WB)
            // Reserved           :6
    0x0200, // Maximum Size   (512KB, shared)
    0x0200, // Install Size
    {
        // Supported SRAM Type
        0, // Other             :1
...
SMBIOS_TABLE_TYPE17 mMemDevInfoType17 = {
    ...
    MemoryTypeLpddr4, // MemoryType;                     ///< The enumeration
                      // value from MEMORY_DEVICE_TYPE. (LPDDR4X reported as LPDDR4)
    {
        // TypeDetail;
        0, // Reserved        :1;
        0, // Other           :1;
    ...
    1600,                 // Speed; (LPDDR4X effective, unknown exact)
